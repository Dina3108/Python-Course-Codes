...
class layout_window(QMainWindow):
    ...
    def UI(self):
        ...
        #by replacing QHBoxLayout we can make of horizontal layout box
       #vertical_layout_box=QHBoxlayout()

        vertical_layout_box.addWidget(label1)
        vertical_layout_box.addWidget(label2)
        vertical_layout_box.addWidget(label3)
        vertical_layout_box.addWidget(label4)
        vertical_layout_box.addWidget(label5)

        central_widget.setLayout(vertical_layout_box)        
